...
const { handleUpload, getFile, handleUploads, handleS3Upload, getAllFiles, deleteFileS3, deleteFile, updateFileById, getText, updateTextById } = require('../controller/file')
