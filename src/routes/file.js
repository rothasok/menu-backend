...
const { handleUpload, getFile, handleUploads, handleS3Upload, getAllFiles, deleteFileS3, deleteFile, updateFileById, getText, updateTextById,getFilebyPermissionID } = require('../controller/file')
...
fileRouter.get('/getfilesbypermission/:id', getFilebyPermissionID)
